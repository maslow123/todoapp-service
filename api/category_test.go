...
func TestCreateCategoryAPI(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			buildStubs: func(store *mockdb.MockStore) {
				store.EXPECT().CreateCategory(gomock.Any(), gomock.Any()).
					Times(1).
...
func TestUpdateCategoryAPI(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			checkResponse: func(recorder *httptest.ResponseRecorder) {
				require.Equal(t, http.StatusOK, recorder.Code)
				requireBodyMatchCategoryAfterUpdate(t, recorder.Body, category1)
			},
		},
		{
...
func TestDeleteCategoryAPI(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			buildStubs: func(store *mockdb.MockStore) {
				store.EXPECT().
					DeleteCategory(gomock.Any(), gomock.Eq(category1.ID)).
					Times(1).
					Return(nil)
			},
			checkResponse: func(t *testing.T, recorder *httptest.ResponseRecorder) {
...
func requireBodyMatchCategoryAfterUpdate(t *testing.T, body *bytes.Buffer, category db.Category) {
...
func requireBodyMatchCategories(t *testing.T, body *bytes.Buffer, category []db.Category) {
	data, err := ioutil.ReadAll(body)
	require.NoError(t, err)
